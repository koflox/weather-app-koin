...
internal class HeaderTextView @JvmOverloads constructor(
    context: Context,
    ...
    companion object {
        val TAG: String = HeaderTextView::class.java.simpleName
    }
    ...
    private var strokePaddingStart: Float = 0F
    private var strokePaddingEnd: Float = 0F
